...
const counterBlog = [
	{icon: <i className="ti-bag m-r10" />, num: '15',  title: 'На рынке обучение',},	
	{icon: <i className="ti-user m-r10" />, num: '700',    title: 'Счастливых студентов',},	
	{icon: <i className="flaticon-users m-r10" />, num: '50',   title: 'Экспертные преподватели',},	
	{icon: <i className="ti-mobile m-r10" />, num: '200', title: 'Успешных тестов',},	
];
