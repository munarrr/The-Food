                        ...
                        <div className="container">
                            <div className="row d-flex justify-content-between">
                                <div className="dlab-topbar-left">
                                    <ul>
                                        <li><i className="flaticon-phone-call m-r5"></i>+996 708 00 00 00</li>
                                        <li><i className="ti-location-pin m-r5"></i>Бишкек ул Тоха 56г</li>
                                    </ul>
                                </div>
                                <div className="dlab-topbar-right">
                                    <ul>
                                        <li><i className="ti-skype m-r5"></i>Курсы English</li>
                                        <li><i className="ti-email m-r5"></i> english@example.com</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="container clearfix">
                                ...
                                <div className="extra-nav">
                                    <div className="extra-cell">
                                        <Link to={'./contact'} className="dez-page site-button primary">Хочу поступить</Link>
                                    </div>
                                </div>
